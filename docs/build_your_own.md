...
<table class="equal-column-table">
  <tr>
    <td>
        <figure class="center-figure">
          <img src="custom_assets/images/1 - stage/8.jpg" alt="After stage assembly" width=100%>
      ...
      <td>
        <figure class="center-figure">
          <img src="custom_assets/images/1 - stage/10.jpg" alt="After stage assembly" width=100%>
       ...
       <td>
        <figure class="center-figure">
          <img src="custom_assets/images/1 - stage/11 - connect computer usb line.jpg" alt="After stage assembly" >
...
## Lightpath <a name="lightpath"></a>

## Adjust field-of-view for dual color imaging <a name="filters"></a>
