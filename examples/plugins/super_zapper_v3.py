...
class Controller:
    ...
    away_frames = 30                 # wrong way continuously for ~1 s; waiting longer only loses ground (EIM15+16 analysis)
    ...
    pulse_frames = 45                # light on for this many frames (~1.5 s at 30 fps; 1 s and 2 s both gave ~80 % reversals)
